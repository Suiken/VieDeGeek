...
<div id="anecdotes">
    <div id="text_anecdotes">
        ...
        <div id="split"></div>
        <div id="votes">
            <em> Postée par <a href="inscrit_anecdotes.php?login_inscrit=<?php echo $inscrit[0]['nom_compte_inscrit'] ?>"><?php echo $inscrit[0]['nom_compte_inscrit'] ?> </a> le <?php echo reformeDate($anecdote[0]['date_creation_anecdote']) ?> : 
...
?>
	<div>
		<?php echo $auteur[0]['nom_compte_inscrit'] . "-" . reformeDate($commentaire['date_creation_commentaire']) ?><br/>
