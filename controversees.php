...
if($_GET['numPage'] > 0){
    $anecdotes = anecdotesValideesControversees(($_GET['numPage']-1)*12);
}else if($_GET['numPage'] == 1){
    $anecdotes = anecdotesValideesControversees(0);
}
            ...
            <div id="split"></div>
                <table>
                    <tr>
                        ...
                        <td>
                            <label id="<?php echo $uneAnecdote['num_anecdote']; ?>"><?php echo $uneAnecdote['nb_like'] - $uneAnecdote['nb_dislike'] ?></label> 
...
<div id="bas_de_page">
    <table align="center">
        <tr>
            ...
            if($_GET['numPage']-1 > 0){
            ?>
            <td><a class="numPage" href="controversees.php?numPage=<?php echo $_GET['numPage']-1 ?>">Page pr&eacute;c&eacute;dente</a></td>
            ...
            ?>
                ...
                ?>
                <td><a class="numPage" href="controversees.php?numPage=<?php echo $i+1 ?>" <?php if(($i+1) == $_GET['numPage']){ ?>style="color: white; background-color: #2a757b;"<?php } ?>><?php echo $i+1; ?></a></td>
            <?php
            }
            if($_GET['numPage']+1 <= $nbPages){
            ?>
                <td><div id="split_page"></div></td>
                <td><a class="numPage" href="controversees.php?numPage=<?php echo $_GET['numPage']+1; ?>">Page suivante</a></td>
            <?php
            }
