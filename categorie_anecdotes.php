...
$libelle_categorie = $_GET['libelle_categorie'];

$anecdotes = getCategorieAnecdote($libelle_categorie, $_GET['nbAnecdotes']);
?>

<h1>Catégorie : <?php echo $libelle_categorie; ?></h1>
...
<div id="bas_de_page">
    <table align="center">
        <tr>
            ...
            if ($precedent >= 0) {
                ?>
                <td><a id="valider" href="categorie_anecdotes.php?libelle_categorie=<?php echo $libelle_categorie?>&nbAnecdotes=<?php echo $precedent ?>">Page précédente</a></td>
                <?php
            }
            if ($suivant <= $nbAnecdotes[0][0]) {
                ?>
                <td><a id="valider" href="categorie_anecdotes.php?libelle_categorie=<?php echo $libelle_categorie?>&nbAnecdotes=<?php echo $suivant ?>">Page suivante</a></td>
                <?php
            }
            ?>
        </tr>
