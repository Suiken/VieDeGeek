...
if($_GET['numPage'] > 0){
    $anecdotes = anecdotesValideesMeilleures(($_GET['numPage']-1)*12);
}else if($_GET['numPage'] == 1){
    $anecdotes = anecdotesValideesMeilleures(0);
}
        ...
        <div id="text_anecdotes">
            ...
            <div id="split"></div>
                <table>
                    <tr>
                        <td>   
                            Postée par <a style="color: red;" href="inscrit_anecdotes.php?login_inscrit=<?php echo $inscrit[0]['nom_inscrit'] ?>"> <?php echo $inscrit[0]['nom_inscrit'] ?> </a> le <?php echo reformeDate($uneAnecdote['date_creation_anecdote']); ?>
                        ...
                        <td> / </td>
                        <td> <p>Points :  <label id=e"<?php echo $uneAnecdote['num_anecdote']; ?>"><?php echo $uneAnecdote['nb_like'] - $uneAnecdote['nb_dislike'] ?></label> 
                            <label id="e<?php echo $uneAnecdote['num_anecdote']; ?>"></label></p>   
                        </td>
                        <td> / </td>
                        <td> Categorie : <a href="categorie_anecdotes.php?libelle_categorie=<?php echo $uneAnecdote['libelle_categorie'] ?>"> <?php echo $uneAnecdote['libelle_categorie'] ?> </a> </td>
                    </tr>
                </table>
        </div>
    </div>
...
<div id="bas_de_page">
    <table align="center">
        <tr>
            ...
            if($_GET['numPage']-1 > 0){
            ?>
            <td><a class="numPage" href="meilleurs.php?numPage=<?php echo $_GET['numPage']-1 ?>">Page pr&eacute;c&eacute;dente</a></td>
            ...
            ?>
                ...
                ?>
                <td><a class="numPage" href="meilleurs.php?numPage=<?php echo $i+1 ?>" <?php if(($i+1) == $_GET['numPage']){ ?>style="color: white; background-color: #2a757b;"<?php } ?>><?php echo $i+1; ?></a></td>
            <?php
            }
            if($_GET['numPage']+1 <= $nbPages){
            ?>
                <td><div id="split_page"></div></td>
                <td><a class="numPage" href="meilleurs.php?numPage=<?php echo $_GET['numPage']+1; ?>">Page suivante</a></td>
            <?php
            }
