...
<div id="corp_validation">
    <div id="text_validation">
			...
			?>
				...
				<td><a style="color: white; font-weight: bold; text-decoration: underline;" href="fragments/traitements/bo_suppr_inscrit.php?id=<?php echo $inscrit['num_inscrit'] ?>">Supprimer</a></td>
			    </tr>
